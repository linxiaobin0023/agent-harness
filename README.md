...
```powershell
iwr https://raw.githubusercontent.com/linxiaobin0023/agent-harness/main/init.ps1 -OutFile init.ps1
...
```bash
curl -fsSL https://raw.githubusercontent.com/linxiaobin0023/agent-harness/main/init.sh -o init.sh
bash init.sh
```
